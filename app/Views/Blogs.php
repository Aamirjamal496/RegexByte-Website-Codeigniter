            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <div class="modal fade Model-blog" tabindex="-1" role="dialog"
                            aria-labelledby="mySmallModalLabel">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <div class="card card-plain">
                                        <div class="card-header">
                                            <h4 class="font-weight-bolder">Add Blogs</h4>
                                            <p class="mb-0">Fillout the form to add Blog</p>
                                        </div>
                                        <div class="card-body">
                                            <form role="form" action="<?= base_url('addBlogs'); ?>" method="post"
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card-blog h-100 ">
                                        <img src="<?= base_url('uploads/' . $blog['image']); ?>"
                                            class="card-img-top m-2 mx-6 w-70" style="width:9rem;" alt="...">
                                        <div class="card-body mt-1 px-2 py-2 text-center">
                                            <h5 class="card-title"><?= $blog['title']; ?></h5>
                                            <p class="card-text"><?= $blog['description']; ?></p>
                                            <button type="button" class="btn btn-dark bg-gradient-secondary btn-sm edit-btn"
                                                data-toggle="modal"
                                                data-target="#Modeleditblog<?= $blog['id']; ?>">Edit</button>
                                            <!-- Model for editing blog -->
                                            <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-sm">Small modal</button> -->

                                            <div class="modal fade" id="Modeleditblog<?= $blog['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="editModalLabel">
                                                <div class="modal-dialog modal-md" role="document">
                                                    <div class="modal-content">
                                                        <div class="card card-plain">
                                                            <div class="card-header">
                                                                <h4 class="font-weight-bolder">Edit Blogs</h4>
                                                                <p class="mb-0">Fillout the form to edit Blog</p>
                                                            </div>
                                                            <div class="card-body">
                                                                <form role="form" action="<?= base_url('editB'); ?>"
                                                                    ...
                                                                    <div class="input-group input-group-outline mb-3">
                                                                        ...
                                                                        <input type="text" name="title"
                                                                            value="<?= $blog['title']; ?>"
                                                                            class="form-control" id="edit-title">
                                                                    </div>
                                                                    <div class="input-group input-group-outline mb-3">
                                                                        <textarea class="form-control" name="description"
                                                                            id="edit-description"
                                                                            placeholder="edit-description"><?= $blog['description']; ?></textarea>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <input type="submit"
                                                                            class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0 "></input>
                                            ...
                                            <!-- ModelEnd -->
                                            <!-- Model for editing blog End -->
                                            <a href="<?= base_url('delBlog/' . $blog['id']); ?>"
