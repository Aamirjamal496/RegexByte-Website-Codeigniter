...
.portfolio-thumbnails .swiper-slide {
    width: 100px; /* Thumbnail width */
    height: 80px; /* Thumbnail height */
}

.portfolio-thumbnails .swiper-slide img {
    width: 100%;
    height: auto;
}
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <!-- Script for slider images of portfolio detail -->
                        <script>
document.addEventListener('DOMContentLoaded', function () {
    // Initialize the main slider
    var mainSwiper = new Swiper('.portfolio-details-slider', {
        loop: true,
        pagination: {
    ...
    var thumbnailSwiper = new Swiper('.portfolio-thumbnails', {
        slidesPerView: 4,
        spaceBetween: 10,
        freeMode: true,
